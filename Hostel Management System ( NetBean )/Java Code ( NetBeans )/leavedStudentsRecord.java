 ...
 * @author wasim.sayyed
 */
public class leavedStudentsRecord extends javax.swing.JFrame {

    /**
     * Creates new form leavedStudentsRecord
     */
    public leavedStudentsRecord() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 61, 680, 430));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(leavedStudentsRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
